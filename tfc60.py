...
class Prediction :
    ...
    def setup(self):
        ...
        #
            ...
            net = tflearn.input_data(shape=[None, self.steps_of_history, 1],name="input_layer")
            net = tflearn.lstm(net, n_units=100, activation='tanh',return_seq=True, return_state=False,name="hidden_layer_1")
            net = tflearn.lstm(net, n_units=25, activation='tanh', name="hidden_layer_2")
            net = tflearn.fully_connected(net, 1, activation='tanh',name="output_layer")

        # method
        #    optimizer:adam/sgd
        #    loss:mean_square/categorical
        net = tflearn.regression(net, optimizer='adam', learning_rate=0.0005, loss='mean_square')
